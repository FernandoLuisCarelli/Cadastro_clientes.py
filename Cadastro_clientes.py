...
def cadastrar_cliente():
    ...
    c.execute("INSERT INTO clientes VALUES (:nome,:sobrenome,:email,:telefone,:profissao)",
              {
                  'nome': entry_nome.get(),
...
def exporta_clientes():
    ...
    clientes_cadastrados=pd.DataFrame(clientes_cadastrados,columns=['nome','sobrenome','email','telefone','profissao','Id_banco'])
...
label_Profissao.grid(row=4, column=0, padx=10, pady=10)
...
entry_Profissao.grid(row=4, column=1, padx=10, pady=10)
